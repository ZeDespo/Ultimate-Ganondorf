...
pub const GANON_DOWN_SPECIAL_AIR_MULTIPLIER_FLAG: i32 = 0x69420;
pub const GANON_DOWN_AIR_STALL_FLAG: i32 = 0x69421;
pub const GANON_DOWN_SPECIAL_AIR_CONTINUE_FLAG: i32 = 0x69422;
...
pub const GANON_DOWN_SPECIAL_AIR_COUNTDOWN_FLOAT: i32 = 0x69427;
...
pub trait BomaExt {
    ...
    unsafe fn get_float_duration(&mut self) -> i32;
...
impl BomaExt for BattleObjectModuleAccessor {
    ...
    unsafe fn get_float_duration(&mut self) -> i32 {
        WorkModule::get_int(self, GANON_FLOAT_DURATION_WORK_INT)
    }
    unsafe fn set_float_duration(&mut self, n: i32) {
