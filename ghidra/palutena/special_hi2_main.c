...
void __thiscall
L2CFighterPalutenaghidra::status::SpecialHi2_main
...

{
  ...
  lib::L2CAgent::pop_lua_stack((L2CAgent *)this,1,&LStack80);
  ...
  lua2cpp::L2CFighterCommon::sub_shift_status_main(this,(L2CValue)0xc0,return_value);
  lib::L2CValue::~L2CValue(aLStack64);
  return;
}
