...
void __thiscall
L2CFighterPalutenaghidra::status::SpecialHi3_init
...

{
  ...
  lib::L2CValue::L2CValue(aLStack80,fVar6,return_value_00);
  ...
  lib::L2CValue::L2CValue(aLStack80,fVar6,return_value_01);
  ...
  lib::L2CValue::L2CValue(aLStack80,fVar6,return_value_02);
  ...
  if ((uVar3 & 1) == 0) {
    ...
    lib::L2CValue::L2CValue(aLStack208,0.0,return_value_04);
    ...
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KINETIC_ENERGY_ID_STOP);
    lib::L2CValue::operator*(aLStack160,aLStack96);
    lib::L2CValue::L2CValue(aLStack208,0.0,return_value_03);
    lib::L2CAgent::clear_lua_stack((L2CAgent *)this);
    lib::L2CAgent::push_lua_stack((L2CAgent *)this,aLStack80);
    lib::L2CAgent::push_lua_stack((L2CAgent *)this,aLStack192);
    lib::L2CAgent::push_lua_stack((L2CAgent *)this,aLStack208);
  ...
  if ((uVar3 & 1) == 0) {
    ...
    iVar2 = lib::L2CValue::as_integer(aLStack192);
    fVar6 = (float)app::lua_bind::KineticModule__get_sum_speed_x_impl(this->moduleAccessor,iVar2);
    lib::L2CValue::L2CValue(aLStack80,fVar6,return_value_05);
    lib::L2CValue::operator=(aLStack160,aLStack80);
    lib::L2CValue::~L2CValue(aLStack80);
    lib::L2CValue::~L2CValue(aLStack192);
    lib::L2CValue::L2CValue(aLStack80,FIGHTER_KINETIC_ENERGY_ID_GRAVITY);
    ...
    fVar6 = (float)app::lua_bind::WorkModule__get_param_float_impl(this->moduleAccessor,uVar3,uVar4)
    ;
    lib::L2CValue::L2CValue(aLStack192,fVar6,return_value_06);
    ...
    fVar6 = (float)app::lua_bind::WorkModule__get_param_float_impl(this->moduleAccessor,uVar3,uVar4)
    ;
    lib::L2CValue::L2CValue(aLStack192,fVar6,return_value_07);
    lib::L2CValue::~L2CValue(aLStack208);
    lib::L2CValue::~L2CValue(aLStack80);
    lib::L2CValue::L2CValue(aLStack80,FIGHTER_KINETIC_ENERGY_ID_GRAVITY);
    lib::L2CAgent::clear_lua_stack((L2CAgent *)this);
    ...
    fVar6 = (float)app::lua_bind::WorkModule__get_param_float_impl(this->moduleAccessor,uVar3,uVar4)
    ;
    lib::L2CValue::L2CValue(aLStack80,fVar6,return_value_08);
    lib::L2CValue::operator=(aLStack96,aLStack80);
    lib::L2CValue::~L2CValue(aLStack80);
    lib::L2CValue::~L2CValue(aLStack224);
    lib::L2CValue::~L2CValue(aLStack208);
    ...
    fVar6 = (float)app::lua_bind::WorkModule__get_param_float_impl(this->moduleAccessor,uVar3,uVar4)
    ;
    lib::L2CValue::L2CValue(aLStack80,fVar6,return_value_09);
    ...
    lib::L2CValue::~L2CValue(aLStack80);
    if ((uVar3 & 1) == 0) {
      uVar3 = lib::L2CValue::operator<(aLStack144,aLStack160);
      return_value_10 = extraout_x8_00;
      if ((uVar3 & 1) != 0) {
        lib::L2CValue::operator=(aLStack160,aLStack144);
        return_value_10 = extraout_x8_01;
      }
    }
    else {
      lib::L2CValue::operator-(aLStack144);
      lib::L2CValue::operator=(aLStack160,aLStack80);
      lib::L2CValue::~L2CValue(aLStack80);
      return_value_10 = extraout_x8;
    }
    lib::L2CValue::L2CValue(aLStack80,0.0,return_value_10);
    lib::L2CValue::operator=(aLStack128,aLStack80);
    lib::L2CValue::~L2CValue(aLStack80);
    lib::L2CValue::L2CValue(aLStack80,_FIGHTER_KINETIC_ENERGY_ID_STOP);
    lib::L2CAgent::clear_lua_stack((L2CAgent *)this);
    ...
    fVar6 = (float)app::lua_bind::WorkModule__get_param_float_impl(this->moduleAccessor,uVar3,uVar4)
    ;
    lib::L2CValue::L2CValue(aLStack80,fVar6,return_value_11);
    lib::L2CValue::~L2CValue(aLStack224);
    lib::L2CValue::~L2CValue(aLStack208);
    lib::L2CValue::operator*(aLStack176,aLStack80);
    lib::L2CValue::L2CValue(aLStack224,_FIGHTER_KINETIC_ENERGY_ID_STOP);
    lib::L2CValue::L2CValue(aLStack240,-1.0,return_value_12);
    lib::L2CAgent::clear_lua_stack((L2CAgent *)this);
